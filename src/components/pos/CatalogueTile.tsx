...
export default function CatalogueTile({ label, icon: Icon, price, onClick }: CatalogueTileProps) {
  return (
    <button
      onClick={onClick}
      className="flex min-h-[76px] min-w-[130px] flex-col items-center justify-center gap-1 rounded-2xl border border-white/50 bg-white/40 px-2 py-2 text-center backdrop-blur-md transition-colors duration-150 hover:bg-white/60 active:scale-95 sm:min-h-[100px] sm:min-w-[170px] sm:gap-1.5 sm:rounded-3xl sm:px-3 sm:py-3"
    >

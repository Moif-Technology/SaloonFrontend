...
export default function DiscountModal({
  ...
  return (
    ...
    >
      <div className="flex h-full max-h-[min(640px,92dvh)] w-full max-w-[920px] flex-col overflow-hidden rounded-2xl border border-white/50 bg-white/90 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_8px_32px_rgba(31,17,20,0.18)]">
        {/* Header */}

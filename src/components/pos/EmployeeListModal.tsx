...
export default function EmployeeListModal({
  ...
  return (
    ...
    >
        ...
        <header className="flex shrink-0 flex-col gap-3 border-b border-[#6b1d2f]/10 bg-gradient-to-r from-[#6b1d2f]/8 to-transparent px-5 py-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="h-10 shrink-0 rounded-xl bg-salon-primary px-4 text-sm font-semibold text-white shadow-sm transition hover:opacity-90"
            >
              + Add Employee
            </button>
          </div>
            ...
            <div className="flex w-full max-w-md flex-col overflow-hidden rounded-2xl border border-[#6b1d2f]/10 bg-white shadow-xl">
              <div className="flex shrink-0 items-center justify-between border-b border-[#6b1d2f]/10 bg-gradient-to-r from-[#6b1d2f]/8 to-transparent px-5 py-4">
                ...
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full text-salon-muted hover:bg-[#6b1d2f]/10 hover:text-[#6b1d2f] transition"
              ...
              <div className="space-y-3 p-5 sm:p-6">
                ...
                <div className="mt-6 flex gap-3 pt-2">
                  <Button variant="secondary" size="compact" fullWidth onClick={() => { setFormOpen(false); resetForm(); }}>
                    Cancel
                  </Button>
      ...
      {showToast && (
        <div className="fixed bottom-6 right-6 z-[110] flex items-center gap-3 rounded-xl border border-[#83263c] bg-[#6b1d2f] px-4 py-3 shadow-2xl animate-[slideUp_0.25s_ease-out]">

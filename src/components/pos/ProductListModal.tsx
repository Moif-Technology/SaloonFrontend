...
export default function ProductListModal({
  ...
  onClose,
    ...
    const [formCategoryDropdownOpen, setFormCategoryDropdownOpen] =
  useState(false)
...
function confirmDelete() {
  ...
  type="button"
  onClick={openAddForm}
  className="h-10 rounded-xl bg-[#6b1d2f] px-4 text-sm font-semibold text-white hover:opacity-90"
>
  + Add New Product
</button>
              <button
...
<div className="flex flex-wrap items-center gap-2">
  ...
  <button
    ...
    className="flex h-10 min-w-[160px] items-center justify-between gap-3 rounded-xl border-2 border-rose-200 bg-white px-3 text-sm font-semibold text-rose-900 transition hover:bg-rose-50 focus:outline-none"
  ...
  {categoryDropdownOpen && (
    <div
      className="absolute right-0 top-11 z-30 w-full min-w-[160px] overflow-hidden rounded-lg border border-rose-200 bg-white p-1 shadow-lg"
      role="listbox"
    >
      {[
        ...
        <button
          ...
          className={`flex w-full items-center rounded-md px-3 py-2 text-left text-sm font-medium transition ${
            category === option.value
              ? 'bg-rose-50 font-semibold text-[#6b1d2f]'
...
{formOpen && (
      ...
      <div className="space-y-3">
        <label className="block text-sm font-semibold text-salon-text">
          ...
          <input
            ...
            className={`mt-1 h-10 w-full rounded-xl border-2 bg-white px-3 text-sm font-medium outline-none ${
  ...
  <button
    ...
    className={`mt-1 flex h-10 w-full items-center justify-between rounded-xl border-2 bg-white px-3 text-left text-sm font-medium transition focus:outline-none ${
  ...
  {formCategoryDropdownOpen && (
    <div
      className="absolute left-0 right-0 top-[4.5rem] z-30 overflow-hidden rounded-lg border border-rose-200 bg-white p-1 shadow-lg"
      role="listbox"
    >
  ...
  <input
    ...
    className={`mt-1 h-10 w-full rounded-xl border-2 px-3 text-sm font-medium outline-none transition ${
      skuMode === 'auto'
        ...
        : submitted && !formSku.trim()
          ...
          : 'border-salon-border bg-white focus:border-salon-primary'
    }`}
  />

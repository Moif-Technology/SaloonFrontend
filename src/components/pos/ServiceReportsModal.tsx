            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-salon-muted">
                  Review service performance, bookings, staff assignments, and revenue.
                </p>
              </div>
            </div>
          ...
          <div className="w-full max-w-sm rounded-2xl border border-[#6b1d2f]/20 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.15)]">
            <div className="mb-5">
              ...
              <p className="mt-1.5 text-sm leading-relaxed text-slate-500">
                This will clear the search, category, and staff filters and restore the complete service report.
              </p>
            </div>
